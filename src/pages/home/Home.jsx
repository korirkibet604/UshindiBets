...
function Home() {
  ...
  const { fixtures, fixturesLoading, fixturesError } = useScheduledEvents(
  ...
  useEffect(() => {
    ...
    if (selectedLeague && filteredFixtures) {
      filteredFixtures = filteredFixtures.filter(
        (fixture) => fixture.tournament.id === selectedLeague.id
      );
    }
  ...
  return (
    <div className="main-content">
      ...
      <div className="section-header">
        ...
        <NavLink to="/live" className="view-all">
          View All {filteredEvents && filteredEvents.length}{" "}
      ...
      <div className="matches-grid">
        {
          /*filteredEvents && filteredEvents.length > 0 ? (
                    filteredEvents.slice(0, 5)*/ events &&
            events.map((event) => (
              <div
      ...
      <div className="section-header">
        ...
        <NavLink to="/fixtures" className="view-all">
          View All {upcoming && upcoming.length}{" "}
          <i class="fas fa-solid fa-arrow-right"></i>
        </NavLink>
      </div>
      <div className="matches-grid">
          ...
          <div className="promotions">
            <div className="promo-card">
              ...
              <p className="promo-desc">
                Get £30 in free bets when you deposit and bet £10
              </p>
            ...
            <div className="promo-card">
              ...
              <p className="promo-desc">
                Get up to 50% bonus on your accumulator wins
              </p>
            ...
            <div className="promo-card">
              ...
              <p className="promo-desc">
                Earn free bets every week with our loyalty program
              </p>
